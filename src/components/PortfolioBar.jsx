    ...
    <div className="card card--raised" style={{ padding: 20, marginBottom: 20 }}>
      ...
      {hasHoldings ? (
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            <p style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--faint)', marginBottom: 4 }}>Cash Available</p>
            <p style={{ fontFamily: 'var(--font-mono)', fontSize: 24, fontWeight: 900, color: '#fff' }}>{fmt(cash)}</p>
          </div>
          <p style={{ fontSize: 13, color: 'var(--muted)' }}>No positions yet</p>
        </div>
      )}
    </div>
  )
